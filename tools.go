...
const randomStringSource = "abcdefghijklmnopqrstuvxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_+"
...
// UploadedFiles uploads one or more file to a specified directory, and gives the files a random name.
...
// WriteJSON takes a response status code and arbitrary data and writes to the client
